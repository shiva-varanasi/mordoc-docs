...
Tabellen funktionieren am besten, wenn jede Zeile dieselbe Art von Frage beantwortet.

Verwenden Sie eine Tabelle für:

* Optionen vergleichen
* Felder und ihre Bedeutungen auflisten
* Kleine strukturierte Beispiele zeigen

Vermeiden Sie Tabellen, wenn:

* Der Inhalt hauptsächlich aus langen Absätzen besteht
* Jede Zeile eine andere Form hat
* Die Tabelle breiter als die Seite wird

Wenn eine Tabelle schwer zu überfliegen wird, teilen Sie den Inhalt in normale Abschnitte auf.
